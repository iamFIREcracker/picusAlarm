...
BYTE numUdpSocket = 0;
WORD BUFFER_UDP_LEN[MAX_UDP_SOCKETS_FREERTOS] = {BUFFER1_UDP_LEN, BUFFER2_UDP_LEN};
...
#endif
UDP_SOCKET udpSocket[MAX_UDP_SOCKETS_FREERTOS] = {INVALID_UDP_SOCKET, INVALID_UDP_SOCKET};
...
void TCPIPTask()
{
	...
	#endif
	// Initializing application specific hardware
	HWInit(1);
