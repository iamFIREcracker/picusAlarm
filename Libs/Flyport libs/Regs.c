...
int *UTXREGs[]	=	{	(int*) 0x224 , (int*) 0x234 , (int*) 0x244 , (int*) 0x254};
int *URXREGs[]	=	{	(int*) 0x226 , (int*) 0x236 , (int*) 0x246 , (int*) 0x256};
...
int RPORPos[]  =  	{  -1, 10, -1, 17, 16, 30, -1, 2, 4, 
						3, 12, 11, 24, 23, 22, -1, 8, 6, 
						9, 7, -1, -1, 14, -1, 29, -1     };
